      ...
      return (
        <>
          ...
          <ul className="list-group mt-3">
            ...
            <li className="list-group-item">
              <strong>Song Genre</strong>: { track.primary_genres.music_genre_list[0] === undefined ? 'Sorry, we dont know genre (:' : track.primary_genres.music_genre_list[0].music_genre.music_genre_name}
            </li>
            <li className="list-group-item">
